...
public class Checkers extends JPanel implements ActionListener, ItemListener, MouseMotionListener, MouseListener {
    ...
    ImageIcon redN=new ImageIcon(getClass().getResource("/images/red_normal.jpg"));//red_normal.jpg
    ImageIcon yellowN=new ImageIcon(getClass().getResource("/images/yellow_normal.jpg"));//yellow_normal.jpg
    ImageIcon redK=new ImageIcon(getClass().getResource("/images/red_king.jpg"));//red_king.jpg
    ImageIcon yellowK=new ImageIcon(getClass().getResource("/images/yellow_king.jpg"));//yellow_king.jpg
    ImageIcon hlp=new ImageIcon(getClass().getResource("/images/help.jpg"));//help.jpg
    ImageIcon snp=new ImageIcon(getClass().getResource("/images/sound.jpg"));//sound.jpg
    ImageIcon mup=new ImageIcon(getClass().getResource("/images/mute.jpg"));//mute.jpg
